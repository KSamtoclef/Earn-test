...
-- Run only after earnchat_production_install.sql succeeds.
...
select 'configuration' check_name,version,nigeria_multiplier,kenya_multiplier,daily_cap_ngn,referral_reward_ngn,referral_withdraw_min_ngn from public.earnchat_business_settings where id=true;
