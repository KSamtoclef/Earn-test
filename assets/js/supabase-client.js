...
function loadFeature(src,key){if(document.querySelector(`script[data-feature="${key}"]`))return;const s=document.createElement('script');s.type='module';s.src=`${src}?v=${RELEASE}`;s.dataset.feature=key;document.head.appendChild(s)}
...
function loadRouteFeatures(){const hash=location.hash;if(hash.includes('profile')){loadFeature('./assets/js/features/qualification.js','qualification');loadFeature('./assets/js/kyc-bulk-upgrade.js','kyc-workflows')}if(hash.includes('tasks')||hash.includes('visits'))loadFeature('./assets/js/features/task-status.js','task-status');if(hash.includes('admin')){loadFeature('./assets/js/admin/enhancements.js','admin-enhancements');loadFeature('./assets/js/kyc-bulk-upgrade.js','kyc-workflows')}}
