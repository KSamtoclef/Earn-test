...
export const ROUTES=['landing','register','login','home','earn','chat','visits','upgrade','referrals','withdraw','profile','admin'];
...
export const CHAT_PROMPT_SETS=[
 [
  {prompt:'How has your day been so far?',suggestions:['It has been good. I have been trying to stay productive.','It has been a little busy, but I am doing okay.']},
  {prompt:'What is one thing you would still like to finish today?',suggestions:['I want to complete an important task before I rest.','I would like to organize my plans for tomorrow.']},
 ...
 [
  {prompt:'What is something you are looking forward to this week?',suggestions:['I am looking forward to completing an important goal.','I am hoping to have a calm and productive week.']},
  ...
  {prompt:'What normally helps you continue when things feel difficult?',suggestions:['Talking with someone I trust usually encourages me.','Remembering why I started helps me continue.']},
 ...
 [
  {prompt:'What kind of activity helps you relax after a busy day?',suggestions:['Listening to music helps me relax after a busy day.','Taking a quiet walk usually helps me clear my mind.']},
 ...
 [
  {prompt:'What is something useful you learned recently?',suggestions:['I learned a better way to organize my daily tasks.','I learned something that can help me improve my work.']},
