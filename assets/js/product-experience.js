import'./features/professional-upgrade.js';
...
function addLandingExperience(){
 ...
 section.innerHTML=`<div class="section-heading"><span>TRANSPARENT REWARDS</span><h2>Know what happens after every activity</h2><p>Earn Chat separates work in progress from money that is ready to use.</p></div><div class="reward-flow"><article><i>1</i><h3>Complete an activity</h3><p>Follow the guided-session, sponsored-visit or referral requirements shown on screen.</p></article><article><i>2</i><h3>Pending review</h3><p>Submissions that require review stay pending until a decision is recorded.</p></article><article><i>3</i><h3>Available balance</h3><p>Approved rewards move into the correct wallet and become withdrawable when your requirements are complete.</p></article></div><div class="section-heading" style="margin-top:2.5rem"><span>WORK-BASED LEVELS</span><h2>Progress through activity</h2><p>Approved sessions, sponsored visits, active days and genuine referrals move you forward.</p></div><div class="level-path"><article><i>S</i><h3>Starter</h3><p>Learn the system and begin approved activities.</p></article><article><i>A</i><h3>Active</h3><p>Build a consistent record of completed work.</p></article><article><i>P</i><h3>Pro</h3><p>Unlock stronger limits through proven activity.</p></article><article><i>E</i><h3>Elite</h3><p>Reach the highest activity-based level.</p></article></div><div class="no-pay-note">No paid upgrade. Your approved activity controls your progress.</div>`;
...
function homeClarity(state=currentState){
 ...
 card.innerHTML=`<header><div><h3>Account summary</h3></div></header><div class="member-clarity-grid"><div><small>Pending review</small><b>${pending?pending.toLocaleString():'None shown'}</b></div><div><small>Activity points</small><b>${points.toLocaleString()} AP</b></div><div><small>Active days</small><b>${days.toLocaleString()}</b></div></div>`;
}
...
function ensureActivityGuide(containerId,type){
 ...
 if(!guide){
  ...
  guide.innerHTML='<h2>Sponsored visits</h2><p>Open the approved partner page, stay for the required time, then return to submit.</p><div class="activity-guide-grid"><span>1 · Check reward and time</span><span>2 · Follow the guide</span><span>3 · Return and submit</span></div>';
...
function referralClarity(){
 ...
 box.innerHTML=`<h3>Referral rewards</h3><p>Signup counting and reward qualification are separate.</p><div class="referral-steps"><span>A genuine account created through your link counts toward the withdrawal referral requirement</span><span>Referral reward qualification uses ${days} active day${days===1?'':'s'}</span><span>Qualified rewards are credited after the server confirms the requirement</span></div>`;
}
...
function upgradeClarity(){
 ...
 banner.innerHTML='<h2>Earn your next level</h2><p>Your level increases through approved guided sessions, sponsored visits, active days and genuine referrals. There is nothing to buy.</p>';
