...
if(!failures.length){
 ...
 requireToken(html,'final-completion.js?v=20260809-adminux-r3','Completion runtime is not loaded');
 requireToken(html,'product-experience.js?v=20260809-adminux-r3','Product experience runtime is not loaded');
 requireToken(html,'product-experience.css?v=20260809-adminux-r3','Product experience stylesheet is not loaded');
