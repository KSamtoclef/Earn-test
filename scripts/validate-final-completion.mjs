...
if(!failures.length){
 ...
 requireToken(html,'final-completion.js?v=20260809-controls-r1','Completion runtime is not loaded');
 requireToken(html,'product-experience.js?v=20260809-controls-r1','Product experience runtime is not loaded');
 requireToken(html,'product-experience.css?v=20260809-controls-r1','Product experience stylesheet is not loaded');
