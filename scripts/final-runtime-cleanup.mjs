...
update('assets/js/app.js',source=>{
 ...
 const brokenButtons="$('[data-chat-next]',$('#chat-ready')).forEach";
 if(!next.includes(brokenButtons))throw new Error('Post-chat button binding marker not found');
 next=next.replace(brokenButtons,"$$('[data-chat-next]',$('#chat-ready')).forEach");
 return next;
});
...
// Final self-cleaning migration trigger.
